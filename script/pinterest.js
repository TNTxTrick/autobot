...
module.exports.run = async function({
  ...
  if (!input) {
    api.sendMessage(`Please enter the format! \n\nExample: ${prefix}pinterest bae suzy => 10 (it depends on you how many images you want to appear in the result).`, event.threadID, event.messageID);
  } else {
    try {
